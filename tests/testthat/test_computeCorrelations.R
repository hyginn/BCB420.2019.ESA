...
expect_equal(expected["PHALY"][[1]], calcStats(df, "PHALY"), tolerance = 0.01)
expect_equal(expected["SLIGR"][[1]], calcStats(df, "SLIGR"), tolerance = 0.01)
expect_equal(expected["NLRIN"][[1]], calcStats(df, "NLRIN"), tolerance = 0.01)
