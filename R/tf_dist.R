...
#' @param geneList A list of lists of transcription factors than have binding sites upstream of genes. Generated by calling fetchData("GTRDgeneTFs").
...
tf_sim <- function(gene1, gene2, geneList) {
  tfs1 <- geneList[[gene1]]
  len1 <- length(tfs1)
  tfs2 <- geneList[[gene2]]
  len2 <- length(tfs2)
