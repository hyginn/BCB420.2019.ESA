...
#'
#' \code{expr_sim} Calculate the pairwise similarity of gene expression profiles.
#'
...
#' @return Numeric, similarity score: the absolute value of the spearman correlation of the expression profiles of gene1 and gene2. Similarity is returned as 0 if the expression profile for either of the genes is unavailable.
#'
...
expr_sim <- function(gene1, gene2, profiles = myQNXP) {
  if (is.na(profiles[gene1]) | is.na(profiles[gene2]))
