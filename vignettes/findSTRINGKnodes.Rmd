...
bibliography: findSTRINGKnodes.bib
---
...
The resulting Knode values are plotted in a labelled scatterplot using `ggplot2`. Only the number of genes equal to the number of genes in the input system are plotted. Genes that are part of the input system are labelled in green, and those that are not are labelled in red.
