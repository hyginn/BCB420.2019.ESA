...
references:
- id: steipe2019
  title: 'EnrichDepletTF'
  author:
  - family: Sapir
    given: Labes
    orcid: 0000-0002-9478-5974
...
This Vignette the EnrichDepletTF function of BCB420.2019.ESA package. See the `BCB420.2019.ESA` for more options and related functions.
