...
```{r}
source('~/Bioinformatics/BCB420.2019.ESA/R/EnrichDepletTF.R', echo = TRUE)

PHALY <- EnrichDepletTF(sys = "PHALY")
...
As shown by this example, non of the queried transcription factors were found to be enriched for the positively correlated pairs of genes of the "PHALY" system.
```{r}
#For BH cutoff
PHALY[PHALY$Enrichment_P_value < PHALY$BH_enrichment, ]

#For bonferroni cutoff
PHALY[PHALY$Enrichment_P_value < PHALY$Bonferroni, ]
```
