...
# Usage of pcreode wrapper
First, initialize the graphs by creating the expression trajectory for a given flow cytometry file. This flow cytometry file should be given in .fcs format. Then, the expression plot can be graphed according to a specific protein/gene, by plotting with `plotExprTrajectory`.
```{r, echo=TRUE}
