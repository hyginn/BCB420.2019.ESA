...
date: "`r Sys.Date()`"
abstract: >
  This Vignette demonstrates how to use the STRINGExplore package to obtain an interactive network from high confidence STRING scores of a curated gene system, or generally any gene list. 
output:
